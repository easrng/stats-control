...
.box:not(:root){all:initial;line-height:1.45;font-family:system-ui,sans-serif;background:white ;position:fixed ;bottom:0 ;left:0 ;margin:1rem ;padding:0.5rem ;max-width:25rem ;border:1px solid #333 ;border-radius:4px ;min-height:8rem ;display:flex ;flex-direction:column ;width:calc(100% - 2rem) ;box-sizing:border-box }
